...
const Blog = () => {
    return (
        <div className='mt-8 text-left'>
            ...
            <h1 className='font-semibold text-lg my-2'>2.What is React Custom Hook?</h1>
            ...
            <h1 className='font-semibold text-lg my-2'>3.What is useRef?</h1>
            ...
            <h1 className='font-semibold text-lg my-2'>4.What is UseMemo?</h1>
